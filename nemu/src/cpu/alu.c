...
void set_CF_sub(uint32_t dest, uint32_t res, size_t data_size)
{
	dest = sign_ext(dest & (0xFFFFFFFF >> (32 - data_size)), data_size);
	res = sign_ext(src & (0xFFFFFFFF >> (32 - data_size)), data_size);
...
#else
	int64_t src_64 = sign_ext_64(src & (0xFFFFFFFF >> (32 - data_size)), data_size);
	int64_t dest_64 = sign_ext_64(dest & (0xFFFFFFFF >> (32 - data_size)), data_size);
	int64_t res = 0;
	res = src_64 * dest_64;
	return res;
#endif
